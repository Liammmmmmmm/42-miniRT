...
#    Updated: 2025/08/29 10:27:34 by lilefebv         ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
SRC_DIR_GPU         = src/
SRC_FILE_GPU        = main.c main_cpu.c main_shader.c main_shader_utils.c
...
M_FILE  =   $(addprefix $(SRC_DIR_GPU), $(SRC_FILE_GPU)) \
