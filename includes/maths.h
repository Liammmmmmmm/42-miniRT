...
t_fcolor	add_fcolor_float3(t_fcolor c1, const float *c2);
...
void		multiply_matrix_3x3(double res[3][3], double a[3][3],
				double b[3][3]);
void		multiply_matrix_4x4(double res[4][4], double a[4][4],
				double b[4][4]);
...
char		init_hyperboloid_quadratic(t_quadratic *q, t_hyperboloid *h,
				t_ray *r);
