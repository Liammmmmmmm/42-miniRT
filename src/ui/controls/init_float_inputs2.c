...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   init_float_inputs2.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: lilefebv <lilefebv@student.42lyon.fr>      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/27 13:42:29 by lilefebv          #+#    #+#             */
/*   Updated: 2025/06/10 15:52:50 by lilefebv         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	ambiant_and_more(t_minirt *minirt)
{
	...
	link_float_input(&minirt->controls.float_input[28],
	...
	link_float_input(&minirt->controls.float_input[29],
		&minirt->controls.res_render_x);
	...
	link_float_input(&minirt->controls.float_input[30],
		&minirt->controls.res_render_y);
