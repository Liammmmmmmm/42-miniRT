...
void	init_focal_sliders_value(t_minirt *minirt)
{
	...
	minirt->controls.sliders[0].min = 0;
	minirt->controls.sliders[0].max = 180;
	minirt->controls.sliders[0].y = 195;
	minirt->controls.sliders[0].x = 60;
