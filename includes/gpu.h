...
/*   Updated: 2025/08/21 19:33:59 by madelvin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		convert_triangle(t_scene *cpu, t_gpu_structs *gpu,
				uint32_t *triangle, uint32_t i);
...
void		convert_cone(t_scene *cpu, t_gpu_structs *gpu, uint32_t *primitive,
				uint32_t i);
void		convert_cylinder(t_scene *cpu, t_gpu_structs *gpu,
				uint32_t *primitive, uint32_t i);
void		convert_sphere(t_scene *cpu, t_gpu_structs *gpu,
				uint32_t *primitive, uint32_t i);
...
void		convert_scene(t_minirt *minirt, t_scene *scene,
				t_viewport *viewport, t_gpu_structs *gpu);
int			convert_scene_build(t_minirt *minirt, t_scene *scene,
				t_viewport *viewport, t_gpu_structs *gpu_structs);
int			build_caustic_grid(t_scene *scene, t_gpu_structs *gpu,
				float cell_size, int table_size);

uint32_t	hash_cell(int ix, int iy, int iz, int table_size);
void		compute_photons_aabb(t_photon *photons, int count, float *min,
				float *max);
