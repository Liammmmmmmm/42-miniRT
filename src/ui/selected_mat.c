...
/*   Updated: 2025/06/05 14:59:17 by lilefebv         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	set_selected_mat(t_minirt *minirt, t_mat *mat)
{
	...
	link_color_picker(&minirt->controls.color_picker[2], &mat->emission_color_tmp);
	...
	minirt->controls.dropdown[8].selected = (void **)&mat->emission_strength_tex;
